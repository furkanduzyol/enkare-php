    ...
    <i id="bar" class="fas fa-outdent"></i>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct10.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct11.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct12.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct14.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct15.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct16.php';">
        ...
        <section id="pagination" class="section-p1">
            <a href="4takımpage1.php">1</a>
            <a href="4takımpage2.php" style="background-color: #134;">2</a>
            <a href="4takımpage3.php">3</a>
            <a href="4takımpage4.php">4</a>
            <a href="4takımpage3.php"><i class="fa-solid fa-arrow-right-long"></i></a>
