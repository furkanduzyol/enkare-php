    ...
    <i id="bar" class="fas fa-outdent"></i>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct17.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct18.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct19.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct20.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct21.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct22.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct23.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct24.php';">
        ...
        <section id="pagination" class="section-p1">
            ...
            <a href="6takımpage3.php" style="background-color: #134;">3</a>
            <a href="6takımpage4.php">4</a>
            <a href="6takımpage5.php">5</a>
            <a href="6takımpage4.php"><i class="fa-solid fa-arrow-right-long"></i></a>
