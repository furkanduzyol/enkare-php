...
<div id="mobile">
    ...
    <i id="bar" class="fas fa-outdent"></i>
        ...
        <section class="kategoriadı">
            <h2>4 Kişilik İç Mekan Takımlar</h2>
        </section>
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct1.php';">
                    ...
                    <div class="des">
                        <span>Enkare</span>
                        <h5>Beyaz Elisa Masa Sandalye Takımı, 4 Kişilik Mutfak Masası, Teddy...</h5>
                        <div class="star"> 
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct2.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct3.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct4.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct6.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct7.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct8.php';">
        ...
        <section id="pagination" class="section-p1">
            <a href="4takımpage1.php" style="background-color: #134;">1</a>
            <a href="4takımpage2.php">2</a>
            <a href="4takımpage3.php">3</a>
            <a href="4takımpage4.php">4</a>
            <a href="4takımpage2.php"><i class="fa-solid fa-arrow-right-long"></i></a>
