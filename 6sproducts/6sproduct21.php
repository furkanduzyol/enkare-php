    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/6kişilik fotolar/6.21.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.21.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.21.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.21.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.21.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>Şile Masa Sandalye Takımı/h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-46" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(46)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>🌟 Zarafetin ve işlevselliğin mükemmel buluşması! Şile Masa Sandalye Takımı, çift kanat açılır mekanizmasıyla yaşam alanlarınıza pratiklik katıyor. Krem rengiyle ferah bir atmosfer yaratırken, işlevsel tasarımıyla da beklentilerinizi karşılıyor. Artık misafirlerinizi ağırlarken ekstra masa alanı ihtiyacı derdi yok! Estetik görünümü ve kullanışlılığıyla öne çıkan bu takım, evinizdeki her anı daha keyifli hale getiriyor. Hayalini kurduğunuz ferah ve şık bir yaşam alanı için EnkareHome'un Şile Masa Sandalye Takımı tam da aradığınız şey! ✨ <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='6sproduct20.php';">
                    <img src="../img/6kişilik fotolar/6.20.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='6sproduct22.php';">
                    <img src="../img/6kişilik fotolar/6.22.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='6sproduct23.php';">
                    <img src="../img/6kişilik fotolar/6.23.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='6sproduct24.php';">
                    <img src="../img/6kişilik fotolar/6.24.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
        ...
        <footer class="section-p1">
            ...
            <div class="col">
                ...
                <a href="../cart.html">Sepetimi Göster</a>
