    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/6kişilik fotolar/6.32.1.jpg" width="100%" id="MainImg" alt="" height="440px">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.32.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.32.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.32.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.32.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>Liyon Masa & Liyon Sandalye Takımımız</h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-57" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(57)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>90x165 ölçü 6 kişilik
                    95x190 ölçü 8 kişilik <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='6sproduct31.php';">
                    <img src="../img/6kişilik fotolar/6.31.1.jpg" alt="" height="340px">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='6sproduct33.php';">
                    <img src="../img/6kişilik fotolar/6.33.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='6sproduct34.php';">
                    <img src="../img/6kişilik fotolar/6.34.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='6sproduct35.php';">
                    <img src="../img/6kişilik fotolar/6.35.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
