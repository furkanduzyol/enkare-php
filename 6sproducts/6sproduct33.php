    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/6kişilik fotolar/6.33.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.33.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.33.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.33.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/6kişilik fotolar/6.33.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>Ürün Bilgileri Güncellendi</h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-58" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(58)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>Takım 6 Sandalye 1 Masadan oluşmaktadır. <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro" onclick="window.location.href='6sproduct32.php';">
                    <img src="../img/6kişilik fotolar/6.32.1.jpg" alt="" height="340px">
                    <div class="des">
                        <span>Enkare</span>
