    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.25.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.25.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.25.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.25.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.25.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>X Ayaklı Gloss Masa & Zeta Sandalye</h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-25" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(25)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>alon&Mutfak

                    📌 Masa ayağı ortadan X ayaklıdır.
                    -Altın, gümüş nikelaj kaplamalı ve siyah statik boyalı
                    📌 Sandalye kumaşı kolay temizlenir keten kumaştır.
                    📌 Sandalye ayakları,
                    -Altın, gümüş nikelaj kaplamalı ve siyah statik boyalı. <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro" onclick="window.location.href='4sproduct24.php';">
