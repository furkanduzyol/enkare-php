    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.8.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.8.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.8.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.8.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.8.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>Defne Masa Sandalye Takımı</h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-8" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(8)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span> 💫 Zarafetin ve modern tasarımın mükemmel uyumu: Defne Masa Sandalye Takımı. Yuvarlak ahşap masa, sıcaklığıyla mekanınıza samimiyet katarken, metal ayaklı sandalyeler şıklığı ve dayanıklılığı bir araya getiriyor. Evinizde sofistike bir dokunuş üretmeye hazır olun! <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro" onclick="window.location.href='4sproduct9.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproduct10.php';">
                    <img src="../img/4kişilik fotolar/4.10.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct11.php';">
                    <img src="../img/4kişilik fotolar/4.11.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
