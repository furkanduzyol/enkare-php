    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.6.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.6.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.6.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.6.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.6.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>Bergama Masa & Hazarenlı Zion Sandalye</h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-6" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(6)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>Modern tasarımıyla her mekanınıza zarafet katıyor. Hazeranlı sandalyelerle mükemmel uyumu sağlayarak hem şıklığı hem de konforu bir arada sunuyor. Ahşabın sıcaklığını ve doğallığını hissedeceğiniz bu set, günlük kullanım için ideal! 🍂✨ <br>
