    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.13.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.13.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.13.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.13.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.13.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details"><h6><a href="../4takımpage1.php" style="text-decoration: none; color: black;">Mağaza</a> / <a href="../4takımpage1.php" style="text-decoration: none; color: black;">4 Kişilik İç Mekan Takımlar</a></h6>
                
                <h4>EX Ayaklı Gloss Masa & Papatya Sandalye/h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-13" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(13)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>💫 Dayanıklı ve Estetik: X Ayaklı Gloss Masa, MDF malzemesi ve açılır mekanizmasıyla fonksiyonel bir şıklık sunuyor. Papatya Sandalye ile harika bir kombin! 🌼 <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='4sproduct12.php';">
                    <img src="../img/4kişilik fotolar/4.12.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct14.php';">
                    <img src="../img/4kişilik fotolar/4.14.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct15.php';">
                    <img src="../img/4kişilik fotolar/4.15.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct16.php';">
                    <img src="../img/4kişilik fotolar/4.16.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
