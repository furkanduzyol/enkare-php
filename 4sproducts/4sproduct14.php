    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.14.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.14.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.14.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.14.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.14.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>X Ayaklı Gloss Masa & Erciyes Sandalye</h4>
                <h2 class="price">8.900,00 TL</h2>
                <<input type="number" id="quantity-14" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(14)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>💫 Evinizde şıklığı ve fonksiyonelliği bir araya getirin! X Ayaklı Gloss Masa, açılır mekanizmasıyla genişleyebilir. Erciyes Sandalyeler ise şık Babyface kumaşıyla mükemmel bir uyum sağlar. <br>
