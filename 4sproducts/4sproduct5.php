    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.5.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.5.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.5.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.5.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.5.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>Küçük MDF Masa & Elisa Sandalye</h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-5" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(5)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>Minimalizmin zarif dokunuşuyla tanışın! Beyaz MDF kare masa ve modern metal detaylı Elisa sandalyeler, mutfağınıza hem fonksiyonel hem de estetik bir dokunuş katıyor. Kompakt yapısıyla her alana uyum sağlayan bu set, konforlu oturma deneyimi ve sağlam yapısıyla uzun yıllar size eşlik edecek.▫️✨ <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro" onclick="window.location.href='4sproduct7.php';">
                    <img src="../img/4kişilik fotolar/4.7.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct8.php';">
                    <img src="../img/4kişilik fotolar/4.8.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
