    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.19.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.19.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.19.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.19.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.19.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <input type="number" id="quantity-19" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(19)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>nkareHome'un zarif ve kullanışlı ŞİLE masa ve sandalye takımı, babyface kumaş ve şık gri rengiyle dikkat çekiyor. Masanın çift kanat açılır mekanizmasıyla pratik kullanım sağlarken, sandalyelerdeki detaylar estetiği ön plana çıkarıyor. Modern tasarımıyla yaşam alanlarınıza şıklık katın! <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='4sproduct18.php';">
                    <img src="../img/4kişilik fotolar/4.18.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct20.php';">
                    <img src="../img/4kişilik fotolar/4.20.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
