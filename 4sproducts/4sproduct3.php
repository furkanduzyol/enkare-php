    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.3.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.3.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.3.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.3.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.3.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>X Ayaklı Gloss Masa & Metal Polo Sandalye</h4>
                <h2 class="price">8.900,00 TL</h2>
                
                <input type="number" id="quantity-3" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(3)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>Yenilikçi tasarım ve dayanıklılığın buluştuğu X ayaklı Gloss Masa ile metal polo sandalyeler, modern yaşam alanlarınızı şıklıkla donatıyor. Çift kanat açılır mekanizması sayesinde pratik kullanım sunan bu masa sandalye takımı, her davet için ideal. Metal dayanıklılığı ile uzun ömürlü bir şıklık arıyorsanız, bu set tam size göre! 🌟<br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='4sproduct2.php';">
                    <img src="../img/4kişilik fotolar/4.2.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct4.php';">
                    <img src="../img/4kişilik fotolar/4.4.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct5.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproduct6.php';">
                    <img src="../img/4kişilik fotolar/4.6.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
