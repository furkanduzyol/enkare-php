    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.20.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.20.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.20.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.20.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.20.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <input type="number" id="quantity-20" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(20)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>💫 Elisa Masa Sandalye Takımı, İskandinav tarzının yalın estetiğini yaşam alanlarınıza taşıyor. Doğal beyaz yuvarlak masa, sade kavherengi sandalyeler ve zarif metal detaylar ile huzurlu bir atmosfer oluşturuyor. Fonksiyonel tasarımıyla öne çıkan bu takım, sade güzelliği ve zamansız şıklığı bir araya getiriyor. Elisa ile evinizde ferahlığı ve İskandinav ruhunu hissedin. 🍃✨ <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='4sproduct19.php';">
                    <img src="../img/4kişilik fotolar/4.19.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct21.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproduct22.php';">
                    <img src="../img/4kişilik fotolar/4.22.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='4sproduct23.php';">
                    <img src="../img/4kişilik fotolar/4.23.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
