    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/4kişilik fotolar/4.18.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.18.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.18.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.18.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/4kişilik fotolar/4.18.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <h4>Ladin Ağacı Kütük Masa & Zen Sandalye</h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-18" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(18)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>NkareHome'dan size özel bir Zen deneyimi sunuyoruz: Doğanın sakinliği ve zarafetiyle tasarlanmış Ladin Ağacı Kütük Masa ve Zen Sandalyenin dayanıklı yapısıyla İç mekanınıza güven, doğallık ve huzur katmanın tam zamanı! 🌿✨ <br>
