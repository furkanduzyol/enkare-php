...
<div id="mobile">
    ...
    <i id="bar" class="fas fa-outdent"></i>
        ...
        <section class="kategoriadı">
            <h2>Balkon ve Bahçe Dış Mekan Takımlar</h2>
        </section>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='sbalkonbahce/8sproduct9.php';">
                ...
                <div class="pro" onclick="window.location.href='sbalkonbahce/8sproduct10.php';">
                ...
                <div class="pro" onclick="window.location.href='sbalkonbahce/8sproduct12.php';">
                    <img src="img/balkonbahce/8.12.1.jpg" alt="" style="height: 340px;">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='sbalkonbahce/8sproduct13.php';">
                    <img src="img/balkonbahce/8.13.1.jpg" alt="" style="height: 340px;">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='sbalkonbahce/8sproduct14.php';">
                    <img src="img/balkonbahce/8.14.1.jpg" alt="" style="height: 340px;">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='sbalkonbahce/8sproduct15.php';">
                    <img src="img/balkonbahce/8.15.1.jpg" alt="" style="height: 340px;">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='sbalkonbahce/8sproduct16.php';">
                    <img src="img/balkonbahce/8.16.1.jpg" alt="" style="height: 340px;">
                    <div class="des">
                        <span>Enkare</span>
                        <h5>Elisa Masa Sandalye Takımı, 4 Kişilik Mutfak Masası, Teddy...</h5>
                        <div class="star"> 
        ...
        <section id="pagination" class="section-p1">
            <a href="balkonbahce1.php">1</a>
            <a href="balkonbahce2.php" style="background-color: #134;">2</a>
