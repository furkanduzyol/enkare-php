    ...
    <i id="bar" class="fas fa-outdent"></i>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct9.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct10.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct12.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct13.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct14.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct15.php';">
        ...
        <section id="pagination" class="section-p1">
            ...
            <a href="6takımpage2.php" style="background-color: #134;">2</a>
            <a href="6takımpage3.php">3</a>
            <a href="6takımpage4.php">4</a>
            <a href="6takımpage5.php">5</a>
            <a href="6takımpage3.php"><i class="fa-solid fa-arrow-right-long"></i></a>
