    ...
    <i id="bar" class="fas fa-outdent"></i>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct2.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct3.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct4.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct5.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct7.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct8.php';">
        ...
        <section id="pagination" class="section-p1">
            <a href="6takımpage1.php" style="background-color: #134;">1</a>
            <a href="6takımpage2.php">2</a>
            <a href="6takımpage3.php">3</a>
            <a href="6takımpage4.php">4</a>
            <a href="6takımpage5.php">5</a>
            <a href="6takımpage2.php"><i class="fa-solid fa-arrow-right-long"></i></a>
