    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/balkonbahce/8.3.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.3.1.jpg " width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.3.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.3.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.3.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                <h6><a href="../4takımpage1.php" style="text-decoration: none; color: black;">Mağaza</a> / <a href="../balkonbahce1.php" style="text-decoration: none; color: black;">Balkon ve Bahçe Mobilyaları</a></h6>
                 <h4> Fiesta Balkon Bahçe Takımı & Ladin Ağacı Kütük Masa/h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-64" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(64)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>Fiesta Balkon Takımı kütük masa detaylarıyla bahçenize rustik bir dokunuş katıyor. Hem estetik hem de fonksiyonel olan bu takım, dış mekan keyfinizi en üst seviyeye çıkaracak. 🌿 <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='8sproduct2.php';">
                    <img src="../img/balkonbahce/8.2.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='8sproduct4.php';">
                ...
                <div class="pro" onclick="window.location.href='8sproduct6.php';">
                    <img src="../img/balkonbahce/8.6.1.jpg" alt="" height="340px">
                    <div class="des">
                        <span>Enkare</span>
