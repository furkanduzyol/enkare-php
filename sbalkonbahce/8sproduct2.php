    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/balkonbahce/8.2.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.2.1.jpg " width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.2.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.2.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.2.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
               ...
               <h4>Fiesta Balkon Bahçe Takımı</h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-63" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(63)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                 <span>💫Yazın tadını çıkarırken şıklığınızı Fiesta Balkon Bahçe Takımı ile tamamlayın. Konfor ve estetiğin buluştuğu bu set ile evinizde yeni yaşam alanı oluşturacaksınız! 🌺✨ <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='8sproduct1.php';">
