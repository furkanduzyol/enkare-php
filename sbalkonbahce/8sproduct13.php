    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/balkonbahce/8.13.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.13.1.jpg " width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.13.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.13.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.13.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
             ...
             <h4> Frezya Bahçe ve Balkon Takımımız</h4>
                ...
                <input type="number" id="quantity-74" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(74)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span> 🥰 Sütlü Kahve kıvamında 😉 Enkare Frezya Takım 3 Sandalye 1 Masadan oluşmaktadır. <br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro" onclick="window.location.href='8sproduct16.php';">
                    <img src="../img/balkonbahce/8.16.1.jpg" alt="" height="340px">
                    <div class="des">
                        <span>Enkare</span>
