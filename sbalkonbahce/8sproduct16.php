    ...
    <div class="dropdown-menu">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="../img/balkonbahce/8.16.1.jpg" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.16.1.jpg " width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.16.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.16.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="../img/balkonbahce/8.16.4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <h4> Frezya Bahçe ve Balkon Takımımız</h4>
                <h2 class="price">8.900,00 TL</h2>
                <input type="number" id="quantity-77" value="1"> <!-- Input field for quantity -->
                <button class="normal addCart" onclick="handleAddToCart(77)">Sepete Ekle</button>
                
                <h4>Ürün Açıklaması:</h4>
                <span>Frezya Bahçe ve Balkon Takımı 3 Sandalye 1 Masadan oluşmaktadır. <br>

                     <strong>Masa;</strong> <br>
                    
                      Ürün Kumaşı Silinebilir Kumaştır<br>

                     Solmaya ve Yıpranmaya Karşı Dayanıklı Keten Kumaş<br>
                     
                    Metaller Siyah Renk Statik Fırın Boyalıdır. Çizilmeye Karşı Dayanıklıdır<br>
                     
                     Ürün Kollarında Gürgen Ağacı Kullanılmıştır.<br>
                     
                     Kurulum gerektirmez tamamen monte üründür.<br>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='8sproduct12.php';">
                    <img src="../img/balkonbahce/8.12.1.jpg" alt="" height="340px">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='8sproduct13.php';">
                    <img src="../img/balkonbahce/8.13.1.jpg" alt="" height="340px">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='8sproduct14.php';">
                    <img src="../img/balkonbahce/8.14.1.jpg" alt="" height="340px">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='8sproduct15.php';">
                    <img src="../img/balkonbahce/8.15.1.jpg" alt="" height="340px">
                    <div class="des">
                        <span>Enkare</span>
