    ...
    <i id="bar" class="fas fa-outdent"></i>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct18.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct19.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct20.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct22.php';">
                ...
                <div class="pro" onclick="window.location.href='4sproducts/4sproduct23.php';">
        ...
        <section id="pagination" class="section-p1">
            ...
            <a href="4takımpage3.php" style="background-color: #134;">3</a>
            <a href="4takımpage4.php">4</a>
            <a href="4takımpage4.php"><i class="fa-solid fa-arrow-right-long"></i></a>
