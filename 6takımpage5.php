    ...
    <i id="bar" class="fas fa-outdent"></i>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct33.php';">
                    <img src="img/6kişilik fotolar/6.33.1.jpg" alt="" style="height: 340px;">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct34.php';">
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct35.php';">
                    <img src="img/6kişilik fotolar/6.35.2.jpg" alt="" style="height: 340px;">
                    <div class="des">
                        <span>Enkare</span>
                ...
                <div class="pro" onclick="window.location.href='6sproducts/6sproduct36.php';" style="opacity: 0; pointer-events: none;">
                    <img src="img/6kişilik fotolar/6.36.1.jpg" alt="">
                    <div class="des">
                        <span>Enkare</span>
                        <h5>Beyaz Küçük Mdf Masa, Elisa Sandalye Takımı, Açılabilir...</h5>
                        <div class="star"> 
        ...
        <section id="pagination" class="section-p1">
            ...
            <a href="6takımpage5.php" style="background-color: #134;">5</a>
